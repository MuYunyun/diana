...
describe('String API:', () => {
  describe('#trim()', () => {
    ...
    it('_.trim(" 你好 ， 我在 测试 ", 1) should return "你好，我在测试"', () => {
      assert.equal(_.trim(" 你好 ， 我在 测试 ", 'all'), "你好，我在测试")
    })
    it('_.trim(" 你好 ， 我在 测试 ", 2) should return "你好 ， 我在 测试"', () => {
      assert.equal(_.trim(" 你好 ， 我在 测试 ", 'both'), "你好 ， 我在 测试")
    })
    it('_.trim(" 你好 ， 我在 测试 ", 3) should return "你好 ， 我在 测试 "', () => {
      assert.equal(_.trim(" 你好 ， 我在 测试 ", 'head'), "你好 ， 我在 测试 ")
    })
    it('_.trim(" 你好 ， 我在 测试 ", 4) should return " 你好 ， 我在 测试"', () => {
      assert.equal(_.trim(" 你好 ， 我在 测试 ", 'tail'), " 你好 ， 我在 测试")
    })
  })
  ...
  describe('#changeCase()', () => {
    ...
    it('_.changeCase("abcd", 1) should return "Abcd"', () => {
      assert.equal(_.changeCase("abcd", 'upperCaseFirst'), "Abcd")
    })
    it('_.changeCase("AbCd", 2) should return "aBCD"', () => {
      assert.equal(_.changeCase("AbCd", 'lowerCaseFirst'), "aBCD")
    })
    it('_.changeCase("Ab@Cd", 3) should return "aB@cD"', () => {
      assert.equal(_.changeCase("Ab@Cd", 'toggle'), "aB@cD")
    })
  })
